...
function ResultsComp() {
  ...
  <Card className = "cardContentStyles" >
      ...
      <CardContent>
        When performing a regression analysis, a 'correlation coefficient' is used to determine the strength of a linear relationship. Values of a correlation 
        coefficient can range from -1.00 to 1.00, values closer to -1.00 or 1.00 indicate a strong relationship while values closer to 0.00 indicate no relationship.
        The following guidelines will be used to interpret the correlation coefficients yielded by the regression analyses conducted for this project
        ...
        coefficient yielded by this regression analysis is 0.404 indicating a positive moderate relationship between ASh% and Win%. The second scatter plot explores the 
        relationship between average effective shooting percentage (AES%) and Win%. This analysis yielded similar results as the first with a correlation coefficient of 
  ...
  <Card className = "cardContentStyles" >
      ...
      After conducting the first two regression analyses I wondered if there was a more meaningful way to analyze a teams shooting efficiency. I came up with the 
        ...
        the relationships found in the initial analyses. 
        <br></br><br></br>
        My hypothesis was correct. The regression analyses conducted using the difference of a team’s shooting performance and their opponents shooting performance had 
        a larger correlation coefficient than the initial analyses. The regression analysis using ASh%D yielded a correlation coefficient of 0.76 and the analysis using
        AES%D yielded a correlation coefficient of 0.781. Both of these correlation coefficients indicate a strong positive relationship between their respective 
