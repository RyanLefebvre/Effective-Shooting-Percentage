...
function OverviewComp() {
  ...
  return( <div >         
    <Card className ="cardContentStyles">
      ...
      is worth more than a one-point goal. The formula for ES% is shown below.
      ...
      <Card className ="cardContentStyles">
        ...
        EFG% has been a significant predicator of a team’s offensive performance. For example, in 2013, 
        ...
        team success exists in professional lacrosse. I will compare the relationship between shooting efficiency and team success with
